...
Take 5-10 minutes, write your prompt, and paste it into Claude.ai. See what you get.

If the result isn't what you wanted, revise your prompt and try again. That iteration process - seeing what didn't work and adjusting - is exactly how you get better at this.

Pause the video and try it.

## My Example

So I'll go ahead and do what I just asked you to.

```
Create a landing page for "CodeSnap" - a screenshot tool for developers that makes code screenshots beautiful.
...
Create me a landing page for a habit tracker app.

My app goal is to offer a simple, but efective habit tracker. It is easy to create habits, track progress and set the right schedule. As a competitive advantage, the user can see charts of the habit, showing progress and even export it in a spreadsheet.

Build me:

The Hero Section

Include buttons to download the app in apple and google store

Benefits Over Features

- How simple it is to use, but also how much control one has over their data

Social Proof & Trust

- testimonials of users telling how it changed their lives
